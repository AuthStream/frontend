...
import { CreateProviderResponse, EditProviderResponse, ProviderResponse, ProviderType } from "../api/type";
...
export const useCreateProviders = () => {
    return useMutationAction<CreateProviderResponse, ProviderType>(["providers"], providerService.createProvider);
};
...
export const useEditProviders = () => {
    return useMutationAction<EditProviderResponse, ProviderType>(["providers"], providerService.editProvider, {});
};
export const useDeleteProviders = () => {
    return useMutationAction<{ success: boolean }, string>(["providers"], providerService.deleteProvider, {});
};
